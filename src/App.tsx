      ...
      <div className='pageContainer'>
        ...
        <div className='amc-section'>
          <div ref={amc} className='amc-card'>
            <h1 className='amc-title'>AMC Signups are now CLOSED</h1>
            <hr className='hr-amc' />
            ...
            <p className='amc-content'>AMC signups closed at 11:59 pm on September 15, 2023.</p>
            ...
            <p className='amc-content'>In the future this website will be updated with information about the time and location.</p>
